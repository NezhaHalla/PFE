...
Route::get('/Cours/{resource}/details',[ResourceController::class,'showDetails'])->name('showDetails')->middleware('auth','student_teacher'); //comman t et s
Route::get('/ShowDocuments/{resource}',[ResourceController::class,'showdoc'])->name('showdoc')->middleware('auth','student_teacher'); //common
...
Route::get('/ShowDocuments/{assignment}',[AssignmentController::class,'showdoc'])->name('showdocA')->middleware('auth','student_teacher'); //common t and s
