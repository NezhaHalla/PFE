...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.master','data' => ['title' => 'Modify Password']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['title' => 'Modify Password']); ?>
    <!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <link href="<?php echo e(asset('css/modifypassword.css')); ?>" rel="stylesheet">
</head>
    ...
    <div class="page-wrapper bg-red p-t-180 p-b-100 font-robo">
        <div class="wrapper wrapper--w960">
            <div class="card card-2">
                <div class="card-heading" style="background: url('<?php echo e(asset('storage/images/pass.jpg')); ?>') top left/cover no-repeat;width: 29.1%;display: table-cell;" ></div>
                <div class="card-body">
                    <h2 class="title">Modify Password</h2>
                    <form method="POST" action="<?php echo e(route('password.update',auth()->user()->id )); ?>">
                        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\Users\Admin\Documents\PFE\ScholarNet\resources\views/common/modifypassword.blade.php ENDPATH**/ ?>