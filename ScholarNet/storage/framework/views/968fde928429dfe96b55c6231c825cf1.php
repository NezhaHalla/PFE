    ...
    <body>
        ...
        <div class="formbold-main-wrapper">
            <div class="form-container">
                <form action="<?php echo e(route('editprofile', ['id' => $user->id])); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="class_id">
                            ...
                            <?php $__currentLoopData = $classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $class): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($class->id); ?>" <?php echo e(old('class_id', $user->class_id) == $class->id ? 'selected' : ''); ?>><?php echo e($class->Name); ?></option>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="mb-3">
                        ...
                        <?php if($user->image): ?>
                            <img src="<?php echo e(asset('storage/' . $user->image)); ?>" alt="Current Profile Image" style="max-width: 200px;">
                        <?php else: ?>
...
<?php /**PATH C:\Users\Admin\Documents\PFE\ScholarNet\resources\views/admin/edit_user.blade.php ENDPATH**/ ?>