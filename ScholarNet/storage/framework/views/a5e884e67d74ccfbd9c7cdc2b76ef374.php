...
<?php $component->withAttributes(['title' => 'My Courses']); ?>
    ...
    <body>
        <form action="<?php echo e(route('searchCoursesT')); ?>" method="GET">
...
<?php endif; ?>
<?php /**PATH C:\Users\Admin\Documents\PFE\ScholarNet\resources\views/teacher/myCourses.blade.php ENDPATH**/ ?>