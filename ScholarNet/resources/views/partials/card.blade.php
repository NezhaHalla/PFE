...
<body>
    <div class="card-container">
            ...
            <div class="card">
                ...
                <div class="card-text">
                    <div class="portada" style="background-image: url('{{ asset('storage/' . $user->image) }}');"></div>
                    ...
                    <div class="title-total">
                        ...
                        <div class="desc">{{ date('Y-m-d', strtotime($user->DateDeNaissance)) }}</div>
                        <div class="desc">{{ $user->email }}</div>
                        <div class="actions">
                            <a class="delete" href="{{ route('user.delete', ['id' => $user->id]) }}">Delete</a>
                            <a class="modify" href="{{ route('user.edit', ['id' => $user->id]) }}">Modify</a>
                        </div>
                    </div>
                </div>
            </div>
